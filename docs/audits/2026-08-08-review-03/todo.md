...
- [x] **H-01** P0: select the same-day change on distinct timestamps, not row
...
- [x] **M-05** P1: make the package installable; delete three PYTHONPATH
  workarounds. [`#m-05`](01-code-and-model.md#m-05)
- [x] **M-06** P1: split `source` into `source_file` and `source_spec`.
...
- [x] **M-08** P2: assert the five-day bound the test claims to check.
  [`#m-08`](01-code-and-model.md#m-08)
- [x] **L-09** P3: use the public status tracker in the smoke test.
  [`#l-09`](01-code-and-model.md#l-09)
- [x] **L-10** P3: drop the redundant tuple re-packing and the `field` import.
